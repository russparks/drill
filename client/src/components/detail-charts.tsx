        ...
        <CardContent>
          <ResponsiveContainer width="100%" height={400}>
            <BarChart data={timelineData} margin={{ left: 20, right: 30, top: 30 }}>
              ...
              <Tooltip />
              <Bar dataKey="constructionWeeks" stackId="a" fill="#93c5fd" name="Construction" radius={[0, 0, 0, 0]} stroke="#ffffff" strokeWidth={2}>
                <LabelList 
              ...
              <Bar dataKey="buffer" stackId="a" fill="#9ca3af" name="Buffer/Float" radius={[4, 4, 0, 0]} stroke="#ffffff" strokeWidth={2}>
                <LabelList 
                  dataKey="buffer" 
                  position="center" 
                  style={{ fontSize: '10px', fill: '#1f2937', fontWeight: '500' }} 
