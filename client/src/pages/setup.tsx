            ...
            {(() => {
              ...
              return (
                <span className="flex items-center gap-2 text-xs">
                  ...
                  <span className="text-base font-bold">{preconProjects.length} (£{preconValue.toFixed(1)}M)</span>
                  <span className="bg-yellow-100 text-yellow-800 px-2 py-1 rounded text-xs font-medium">
                    CONSTRUCTION
                  </span>
                  <span className="text-base font-bold">{constructionProjects.length} (£{constructionValue.toFixed(1)}M)</span>
                </span>
              );
            })()}
          </TabsTrigger>
