                  ...
                  {weekInfo && (
                    <div className={`flex justify-end relative ${weekInfo.hasPositiveRetention ? 'opacity-60' : ''}`} style={{ marginTop: '-3px', marginRight: '25px' }}>
                      <div className="bg-white border border-gray-200 rounded-b-lg px-3 py-1.5 text-gray-600 inline-block italic flex justify-center" style={{ 
                        ...
                        zIndex: -1,
                        boxShadow: (() => {
                          if (weekInfo.isGreyedOut || weekInfo.hasPositiveRetention) return 'inset 0 2px 4px rgba(204, 204, 204, 0.3)';
                          switch (project.status) {
                            case 'tender': return 'inset 0 2px 4px rgba(59, 130, 246, 0.3)'; // blue
                            case 'precon': return 'inset 0 2px 4px rgba(34, 197, 94, 0.3)'; // green
                            case 'construction': return 'inset 0 2px 4px rgba(249, 115, 22, 0.3)'; // orange
                            case 'aftercare': return 'inset 0 2px 4px rgba(168, 85, 247, 0.3)'; // purple
                            default: return 'inset 0 2px 4px rgba(107, 114, 128, 0.3)'; // gray
                          }
                        })()
                      }}>
