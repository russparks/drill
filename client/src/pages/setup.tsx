            ...
            {(() => {
              ...
              return (
                <span className="flex items-center gap-2 text-xs">
                  ...
                  <span className="text-base font-bold">{preconProjects.length} <span className="text-sm font-normal">(£{preconValue.toFixed(1)}M)</span></span>
                  <span className="bg-yellow-100 text-yellow-800 px-2 py-1 rounded text-xs font-medium">
                    CONSTRUCTION
                  </span>
                  <span className="text-base font-bold">{constructionProjects.length} <span className="text-sm font-normal">(£{constructionValue.toFixed(1)}M)</span></span>
                </span>
              );
            })()}
          </TabsTrigger>
